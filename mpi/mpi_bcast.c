...
void master(int np, int rank) {
    ...
    // for mpi_broadcast, receive function is the same with send function.
    // the fourth parameter means only this number's process send message,
    // and other processes receive message.
